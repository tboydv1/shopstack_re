...
<html>
  ...
  <br />
            ...
            <div class = "container">
                ...
                <h4 class="shift">Create a Company</h4>
                <p class="shift-rider">Use your work email to create new account... it's free.</p>

                <form:form action ="process" modelAttribute="user"  method = "GET" >
                    
                       <div class="form-row">
                        <div class="form-group col-md-6">
                        <label for="firstname">Firstname</label>
						 
				        		<input  type="text" path="firstName" class="form-control" placeholder="First name"/>
                    ...
                    <div class="form-group">
				        ...
				        <form:input  type="email" path= "phoneNumber" class="form-control" placeholder="phone Number" />
		        		...
		        		<form:input  class="form-control" path="password" placeholder="password" type="text" />
